...
template<> 
void OptionHandler<std::string>::Parse(const std::string& value) { 
  *var = value; 
}

template<> 
void OptionHandler<bool>::Parse(const std::string& value) {
  if (value != "0" && value != "1") {
...
template<> 
const char* OptionHandler<std::string>::GetTypeHint() const {
   return "<string>"; 
}

template<> const char* OptionHandler<int>::GetTypeHint() const {
   return "<int>"; 
}

template<> const char* OptionHandler<uint64_t>::GetTypeHint() const {
   return "<int>"; 
}

template<> const char* OptionHandler<float>::GetTypeHint() const {
   return "<float>"; 
}

template<> const char* OptionHandler<double>::GetTypeHint() const {
   return "<float>"; 
}

template<> const char* OptionHandler<bool>::GetTypeHint() const {
   return "(0 | 1)";
}
