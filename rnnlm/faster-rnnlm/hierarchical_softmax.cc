...
class HSTree::Tree {
 public:
  ...
  // from the root to the word (从根节点到 word 节点)
  ...
  // get array of (path_lengths - 1) indices of [branch ids] that lead from
  // root to the word, [1, 3, 4] (每一层的分支编号)
